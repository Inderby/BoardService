...
insert into user_account (user_id, user_password, nickname, email, memo, created_at, created_by, modified_at,
                          modified_by)
values ('inderby', '1234', 'inderby', 'inderby@mail.com', 'I am inderby.', now(), 'inderby', now(), 'inderby')
;
insert into user_account (user_id, user_password, nickname, email, memo, created_at, created_by, modified_at,
                          modified_by)
values ('inderby2', '1234', 'inderby2', 'inderby2@mail.com', 'I am inderby2.', now(), 'inderby2', now(), 'inderby2')
;
